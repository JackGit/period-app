<template>
  <page>
    <page-header slot="header" title="MONTH">
      <mt-button slot="left">prev</mt-button>
      <mt-button slot="right">next</mt-button>
    </page-header>
    <div>
      <card no-padding>
        <temperature-chart mode="month"></temperature-chart>
      </card>
      <card no-padding>
        <temperature-list style="margin-top: -1px"></temperature-list>
      </card>
    </div>
